...
{
	jQuery('.lightbox-content').css('top','0px');
...
function showLightboxOne()
{
	jQuery('.lightbox-content-One').css('top','0px');
	jQuery('.lightbox-content-One').css('visibility','visible');
	jQuery('.lightbox-content-One').css('opacity','1');
	jQuery('.lightbox-loader').show();
}


function hideLightboxOne()
{
	jQuery('.lightbox-content-One').css('top','-1000px');
	jQuery('.lightbox-content-One').css('visibility','hidden');
	jQuery('.lightbox-content-One').css('opacity','0');
	jQuery('.lightbox-loader').hide();
	jQuery('.black_overlay').hide();
}