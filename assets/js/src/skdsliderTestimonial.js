;(function($){
    ...
    function Skdslider(container, options) {
        ...
        this.element = this.container.wrap('<div class="skdsliderTestimonial"></div>').closest('div.skdsliderTestimonial');
        ...
        this.createNav = function() {
            ...
            if (this.options.showNav) {
                navs = $('<ul class="slide-navs" style="display: none">'+markup+'</ul>');
