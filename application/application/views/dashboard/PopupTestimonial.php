...
<!--<link href="--><?php //echo base_url(); ?><!--assets/js/src/skdslider2.css" rel="stylesheet">-->
...
<div id="demo2Slider">
    <?php foreach ($TestimonialData as $key=>$path){
       // $testimonnialParameter=array('CallType'=>'TestimonialData','PageTitle'=>'TESTIMONIAL', 'TestimonialId'=>$path['Id']);
        ?>
        <div class="slide">
            <a target="_blank" href="<?php echo  base_url().$path['FileUpload'] ?>" >
            <img src="<?php echo  base_url().$path['ThumbImage']; ?>" style="height: 370px; width: auto"/>
            </a>
