    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <span style="float: right"><a class="linkblack" href="<?php echo base_url(); ?>dashboard/index">Dashboard</a> > <a class="linkblack" href="<?php echo base_url(); ?>dashboard/ProjectView">ProjectView</a> VillageData</span>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="card" id="Village">
                    ...
                    <div class="card-body">
                        <table id="VillageTableData" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php foreach($VillageData as $tmpData) { ?>
