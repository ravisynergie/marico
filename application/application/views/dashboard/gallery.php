...
<div id="jssor_1" style="padding:10px;position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
    <!-- Loading Screen -->
    ...
    <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
        <?php
            foreach ($GalleryData as $key=>$path){
        ?>
        <div style="padding:10px;">
            <img data-u="image" src="<?= base_url().$path['ImagePath'] ?>" />
            <div u="thumb" class="thumbtext">
				<span class="schoolname"><?php echo $path['LocationName'] ?></span>
                <span class="captionname"> (<?php echo $path['Caption'] ?>)</span>
			</div>
        </div>
        <?php } ?>
